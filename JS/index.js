...
const apiKey = 'cfc4f9f222f4c0f71e9d8b2182c8cc65'
...
async function updateWeatherInfo(city) {
    ...
    if(weatherData.cod != 200) {
        showdisplaySectionse(notFoundSection)
        return
    }
    const {
        name: country,
    ...
    showdisplaySectionse(weatherInfoSection)
}
...
function showdisplaySectionse(section) {
